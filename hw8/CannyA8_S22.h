...
{ "-lscprof" }; */
/* note _SCE_LOG = 
{ { "Mon Jun 12 00:33:30 2017","scc CannyA8_S1 -sc2sir -I -P -L -l -xcx -xlx -I/opt/sce/inc -P. -P/opt/sce/import -L/opt/sce/lib -lbit4 -lbit -lsim -llonglong -lqthread -xl -Xlinker -xl -R -xl -Xlinker -xl /opt/sce/lib -i CannyA8_S1.sc -o CannyA8_S1.sir",
    "CannyA8_S1.sc","V2.2.1","" },
  { "Mon Jun 12 00:34:40 2017","sce","CannyA8_S1.sc","V2.2.1","Saved to /users/ugrad/2016/fall/jienengy/eecs222/hw8/CannyA8_S22.sir" },
  
  { "Mon Jun 12 00:34:40 2017","scprof -v -m -i /users/ugrad/2016/fall/jienengy/eecs222/hw8/CannyA8_S22 -o /users/ugrad/2016/fall/jienengy/eecs222/hw8/CannyA8_S22.ins.sir CannyA8_S22 ",
    "CannyA8_S22","V2.2.1","Profile Instrumentation Simple mode" } }; */
...
#line 61 "CannyA8_S1.sc"
    i_img_sender (&ImgOut); i_time_sender (&StartTime);
public:

#line 821 "CannyA8_S22.h"
...
#line 63 "CannyA8_S1.sc"
    unsigned char Image[4110080];
};

#line 157 "CannyA8_S1.sc"
...
#line 159 "CannyA8_S1.sc"
    unsigned char EdgeImage[4110080];
};

#line 248 "CannyA8_S1.sc"
...
#line 476 "CannyA8_S1.sc"
    Gaussian_Kernel gauss;

#line 475 "CannyA8_S1.sc"
    Receive_Image receive;
};

#line 487 "CannyA8_S1.sc"
...
#line 795 "CannyA8_S1.sc"
    unsigned char EdgeImage[4110080];
};

#line 939 "CannyA8_S1.sc"
...
#line 1010 "CannyA8_S1.sc"
    DUT canny;

#line 1009 "CannyA8_S1.sc"
    DataIn din;

    DataOut dout;

#line 1008 "CannyA8_S1.sc"
    c_img_queue q1; c_img_queue q2;
};

#line 1024 "CannyA8_S1.sc"
class Main : public _specc::class_type
{
private:
public:

#line 1233 "CannyA8_S22.h"
...
#line 1030 "CannyA8_S1.sc"
    Monitor monitor;

#line 1029 "CannyA8_S1.sc"
    Platform platform;

#line 1026 "CannyA8_S1.sc"
    c_img_queue q1; c_img_queue q2;
    c_time_queue qt;
    Stimulus stimulus;
};
