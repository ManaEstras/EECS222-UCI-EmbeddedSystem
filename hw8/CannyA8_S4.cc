...
#line 171 "CannyA8_S4.cc"
    __PRF_globalCounter[162u]++ ;

#line 136 "CannyA8_S2.sc"
    for(i = 0; true; i++ )
    {   

#line 178 "CannyA8_S4.cc"
	__PRF_globalCounter[163u]++ ;

#line 138 "CannyA8_S2.sc"
	n = i % 20;
	sprintf(infilename, "video/EngPlaza%03d.pgm", n + 1);

#line 185 "CannyA8_S4.cc"
	__PRF_globalCounter[164u]++ ;

#line 144 "CannyA8_S2.sc"
	if (0)

#line 191 "CannyA8_S4.cc"
	{   
...
#line 199 "CannyA8_S4.cc"
	__PRF_globalCounter[166u]++ ;

#line 145 "CannyA8_S2.sc"
	if (read_pgm_image(infilename, Image, 1520, 2704) == 0) {

#line 205 "CannyA8_S4.cc"
	    __PRF_globalCounter[167u]++ ;

#line 146 "CannyA8_S2.sc"
	    fprintf(stderr, "Error reading the input image, %s.\n", infilename);
	    exit(1);
	}

#line 213 "CannyA8_S4.cc"
	__PRF_globalCounter[168u]++ ;

#line 149 "CannyA8_S2.sc"
	ImgOut.send(Image);
	t = now();
...
#line 224 "CannyA8_S4.cc"
int Stimulus::read_pgm_image(

#line 76 "CannyA8_S2.sc"
...
#line 234 "CannyA8_S4.cc"
    __PRF_globalCounter[169u]++ ;

#line 86 "CannyA8_S2.sc"
    if (infilename == ((void *)0))

#line 240 "CannyA8_S4.cc"
    {   
...
#line 87 "CannyA8_S2.sc"
    {   

#line 252 "CannyA8_S4.cc"
	__PRF_globalCounter[171u]++ ;

#line 88 "CannyA8_S2.sc"
	if ((fp = fopen(infilename, "r")) == ((void *)0)) {

#line 258 "CannyA8_S4.cc"
	    __PRF_globalCounter[172u]++ ;

#line 89 "CannyA8_S2.sc"
...
#line 268 "CannyA8_S4.cc"
    __PRF_globalCounter[173u]++ ;

#line 99 "CannyA8_S2.sc"
    fgets(buf, 70, fp);

#line 274 "CannyA8_S4.cc"
    __PRF_globalCounter[174u]++ ;

#line 100 "CannyA8_S2.sc"
    if (strncmp(buf, "P5", 2) != 0) {

#line 280 "CannyA8_S4.cc"
	__PRF_globalCounter[175u]++ ;

#line 101 "CannyA8_S2.sc"
	fprintf(stderr, "The file %s is not in PGM format in ", infilename);
	fprintf(stderr, "read_pgm_image().\n");

#line 287 "CannyA8_S4.cc"
	__PRF_globalCounter[176u]++ ;

#line 103 "CannyA8_S2.sc"
	if (fp != stdin)

#line 293 "CannyA8_S4.cc"
	{   
...
#line 301 "CannyA8_S4.cc"
	__PRF_globalCounter[178u]++ ;

#line 104 "CannyA8_S2.sc"
	return (0);
    }

#line 308 "CannyA8_S4.cc"
    __PRF_globalCounter[179u]++ ;

#line 106 "CannyA8_S2.sc"
    do  {

#line 314 "CannyA8_S4.cc"
...
#line 325 "CannyA8_S4.cc"
    __PRF_globalCounter[181u]++ ;

#line 107 "CannyA8_S2.sc"
    __isoc99_sscanf(buf, "%d %d",  &c,  &r);

#line 331 "CannyA8_S4.cc"
    __PRF_globalCounter[182u]++ ;

#line 108 "CannyA8_S2.sc"
    if (c != cols || r != rows) {

#line 337 "CannyA8_S4.cc"
	__PRF_globalCounter[183u]++ ;

#line 109 "CannyA8_S2.sc"
	fprintf(stderr, "The file %s is not a %d by %d image in ", infilename, cols, rows);
	fprintf(stderr, "read_pgm_image().\n");

#line 344 "CannyA8_S4.cc"
	__PRF_globalCounter[184u]++ ;

#line 111 "CannyA8_S2.sc"
	if (fp != stdin)

#line 350 "CannyA8_S4.cc"
	{   
...
#line 358 "CannyA8_S4.cc"
	__PRF_globalCounter[186u]++ ;

#line 112 "CannyA8_S2.sc"
	return (0);
    }

#line 365 "CannyA8_S4.cc"
    __PRF_globalCounter[187u]++ ;

#line 114 "CannyA8_S2.sc"
    do  {

#line 371 "CannyA8_S4.cc"
...
#line 382 "CannyA8_S4.cc"
    __PRF_globalCounter[189u]++ ;

#line 119 "CannyA8_S2.sc"
    if ((unsigned int)rows != fread(image, cols, rows, fp)) {

#line 388 "CannyA8_S4.cc"
	__PRF_globalCounter[190u]++ ;

#line 120 "CannyA8_S2.sc"
	fprintf(stderr, "Error reading the image data in read_pgm_image().\n");

#line 394 "CannyA8_S4.cc"
	__PRF_globalCounter[191u]++ ;

#line 121 "CannyA8_S2.sc"
	if (fp != stdin)

#line 400 "CannyA8_S4.cc"
	{   
...
#line 408 "CannyA8_S4.cc"
	__PRF_globalCounter[193u]++ ;

#line 122 "CannyA8_S2.sc"
	return (0);
    }

#line 415 "CannyA8_S4.cc"
    __PRF_globalCounter[194u]++ ;

#line 125 "CannyA8_S2.sc"
    if (fp != stdin)

#line 421 "CannyA8_S4.cc"
    {   
...
#line 429 "CannyA8_S4.cc"
    __PRF_globalCounter[196u]++ ;

#line 126 "CannyA8_S2.sc"
    return (1);
}

#line 436 "CannyA8_S4.cc"
...
#line 456 "CannyA8_S4.cc"
    __PRF_globalCounter[104u]++ ;

#line 214 "CannyA8_S2.sc"
    for(i = 0; i < 20; i++ )
    {   

#line 463 "CannyA8_S4.cc"
	__PRF_globalCounter[105u]++ ;

#line 216 "CannyA8_S2.sc"
...
#line 488 "CannyA8_S4.cc"
	__PRF_globalCounter[106u]++ ;

#line 236 "CannyA8_S2.sc"
	if (0)

#line 494 "CannyA8_S4.cc"
	{   
...
#line 177 "CannyA8_S2.sc"
    {   

#line 558 "CannyA8_S4.cc"
	__PRF_globalCounter[114u]++ ;

#line 178 "CannyA8_S2.sc"
	if ((fp = fopen(outfilename, "w")) == ((void *)0)) {

#line 564 "CannyA8_S4.cc"
	    __PRF_globalCounter[115u]++ ;

#line 179 "CannyA8_S2.sc"
...
#line 574 "CannyA8_S4.cc"
    __PRF_globalCounter[116u]++ ;

#line 188 "CannyA8_S2.sc"
    fprintf(fp, "P5\n%d %d\n", cols, rows);

#line 580 "CannyA8_S4.cc"
    __PRF_globalCounter[117u]++ ;

#line 189 "CannyA8_S2.sc"
    if (comment != ((void *)0))

#line 586 "CannyA8_S4.cc"
    {   
	__PRF_globalCounter[118u]++ ;

#line 190 "CannyA8_S2.sc"
	if (strlen(comment) <= 70)

#line 593 "CannyA8_S4.cc"
	{   
...
#line 602 "CannyA8_S4.cc"
    __PRF_globalCounter[120u]++ ;

#line 191 "CannyA8_S2.sc"
    fprintf(fp, "%d\n", maxval);

#line 608 "CannyA8_S4.cc"
    __PRF_globalCounter[121u]++ ;

#line 196 "CannyA8_S2.sc"
    if ((unsigned int)rows != fwrite(image, cols, rows, fp)) {

#line 614 "CannyA8_S4.cc"
	__PRF_globalCounter[122u]++ ;

#line 197 "CannyA8_S2.sc"
	fprintf(stderr, "Error writing the image data in write_pgm_image().\n");

#line 620 "CannyA8_S4.cc"
	__PRF_globalCounter[123u]++ ;

#line 198 "CannyA8_S2.sc"
	if (fp != stdout)

#line 626 "CannyA8_S4.cc"
	{   
...
#line 634 "CannyA8_S4.cc"
	__PRF_globalCounter[125u]++ ;

#line 199 "CannyA8_S2.sc"
	return (0);
    }

#line 641 "CannyA8_S4.cc"
    __PRF_globalCounter[126u]++ ;

#line 202 "CannyA8_S2.sc"
    if (fp != stdout)

#line 647 "CannyA8_S4.cc"
    {   
...
#line 655 "CannyA8_S4.cc"
    __PRF_globalCounter[128u]++ ;

#line 203 "CannyA8_S2.sc"
    return (1);
}

#line 662 "CannyA8_S4.cc"
...
#line 253 "CannyA8_S2.sc"
{   

#line 677 "CannyA8_S4.cc"
    __PRF_globalCounter[63u]++ ;

#line 254 "CannyA8_S2.sc"
    while(1)
    {   

#line 684 "CannyA8_S4.cc"
	__PRF_globalCounter[64u]++ ;

#line 256 "CannyA8_S2.sc"
	ImgIn.receive( &Image);
	ImgOut.send(Image);
    }
}

#line 693 "CannyA8_S4.cc"
...
#line 267 "CannyA8_S2.sc"
{   

#line 708 "CannyA8_S4.cc"
    __PRF_globalCounter[65u]++ ;

#line 268 "CannyA8_S2.sc"
    while(1)
    {   

#line 715 "CannyA8_S4.cc"
	__PRF_globalCounter[66u]++ ;

#line 270 "CannyA8_S2.sc"
	ImgIn.receive( &Image);
	ImgOut.send(Image);
    }
}

#line 724 "CannyA8_S4.cc"
...
#line 279 "CannyA8_S2.sc"
{   
    unsigned char Image[4110080];

#line 740 "CannyA8_S4.cc"
    __PRF_globalCounter[161u]++ ;

#line 282 "CannyA8_S2.sc"
...
#line 768 "CannyA8_S4.cc"
    __PRF_globalCounter[82u]++ ;

#line 332 "CannyA8_S2.sc"
    _specc::waitfor((0 * 1000000000ull) / 20);

#line 774 "CannyA8_S4.cc"
    __PRF_globalCounter[83u]++ ;

#line 333 "CannyA8_S2.sc"
    if (0)

#line 780 "CannyA8_S4.cc"
    {   
...
#line 788 "CannyA8_S4.cc"
    __PRF_globalCounter[85u]++ ;

#line 334 "CannyA8_S2.sc"
...
#line 828 "CannyA8_S4.cc"
    __PRF_globalCounter[89u]++ ;

#line 306 "CannyA8_S2.sc"
    for(i = 0; i < ( *windowsize); i++ ) {

#line 834 "CannyA8_S4.cc"
	__PRF_globalCounter[90u]++ ;

#line 307 "CannyA8_S2.sc"
	x = (float)(i - center);
...
#line 844 "CannyA8_S4.cc"
    __PRF_globalCounter[91u]++ ;

#line 313 "CannyA8_S2.sc"
    for(i = 0; i < ( *windowsize); i++ )

#line 850 "CannyA8_S4.cc"
    {   
...
#line 858 "CannyA8_S4.cc"
    __PRF_globalCounter[93u]++ ;

#line 315 "CannyA8_S2.sc"
    if (0) {

#line 864 "CannyA8_S4.cc"
	__PRF_globalCounter[94u]++ ;

#line 316 "CannyA8_S2.sc"
	printf("The filter coefficients are:\n");

#line 870 "CannyA8_S4.cc"
	__PRF_globalCounter[95u]++ ;

#line 317 "CannyA8_S2.sc"
	for(i = 0; i < ( *windowsize); i++ )

#line 876 "CannyA8_S4.cc"
	{   
	    __PRF_globalCounter[96u]++ ;

#line 318 "CannyA8_S2.sc"
	    printf("kernel[%d] = %f\n", i, kernel[i]);
	}
    }
}

#line 886 "CannyA8_S4.cc"
...
#line 905 "CannyA8_S4.cc"
    __PRF_globalCounter[40u]++ ;

#line 353 "CannyA8_S2.sc"
    if (0)

#line 911 "CannyA8_S4.cc"
    {   
...
#line 919 "CannyA8_S4.cc"
    __PRF_globalCounter[42u]++ ;

#line 354 "CannyA8_S2.sc"
    for(r = rowStart; r < rowEnd; r++ ) {

#line 925 "CannyA8_S4.cc"
	__PRF_globalCounter[43u]++ ;

#line 355 "CannyA8_S2.sc"
	for(c = 0; c < cols; c++ ) {

#line 931 "CannyA8_S4.cc"
	    __PRF_globalCounter[44u]++ ;

#line 356 "CannyA8_S2.sc"
	    dot = 0.000000000000000e+00;
	    sum = 0.000000000000000e+00;

#line 938 "CannyA8_S4.cc"
	    __PRF_globalCounter[45u]++ ;

#line 358 "CannyA8_S2.sc"
	    for(cc = ( -center); cc <= center; cc++ ) {

#line 944 "CannyA8_S4.cc"
		__PRF_globalCounter[46u]++ ;

#line 359 "CannyA8_S2.sc"
		if (((c + cc) >= 0) && ((c + cc) < cols)) {

#line 950 "CannyA8_S4.cc"
		    __PRF_globalCounter[47u]++ ;

#line 360 "CannyA8_S2.sc"
		    dot += (float)image[r * cols + (c + cc)] * kernel[center + cc];
		    sum += kernel[center + cc];
		}
	    }

#line 959 "CannyA8_S4.cc"
	    __PRF_globalCounter[48u]++ ;

#line 364 "CannyA8_S2.sc"
	    tempim[r * cols + c] = dot / sum;
	}
    }
}

#line 968 "CannyA8_S4.cc"
void BlurX_Slice::main(void)

#line 370 "CannyA8_S2.sc"
{   

#line 974 "CannyA8_S4.cc"
    __PRF_globalCounter[49u]++ ;

#line 371 "CannyA8_S2.sc"
    _specc::waitfor(((41680 * 1000000000ull) / 20) / 8);
    blur_x(1520, 2704);
}

#line 982 "CannyA8_S4.cc"
...
#line 1052 "CannyA8_S4.cc"
    __PRF_globalCounter[51u]++ ;

#line 416 "CannyA8_S2.sc"
    if (0)

#line 1058 "CannyA8_S4.cc"
    {   
...
#line 1066 "CannyA8_S4.cc"
    __PRF_globalCounter[53u]++ ;

#line 417 "CannyA8_S2.sc"
    for(c = colStart; c < colEnd; c++ ) {

#line 1072 "CannyA8_S4.cc"
	__PRF_globalCounter[54u]++ ;

#line 418 "CannyA8_S2.sc"
	for(r = 0; r < rows; r++ ) {

#line 1078 "CannyA8_S4.cc"
	    __PRF_globalCounter[55u]++ ;

#line 419 "CannyA8_S2.sc"
	    sum = 0.000000000000000e+00;
	    dot = 0.000000000000000e+00;

#line 1085 "CannyA8_S4.cc"
	    __PRF_globalCounter[56u]++ ;

#line 421 "CannyA8_S2.sc"
	    for(rr = ( -center); rr <= center; rr++ ) {

#line 1091 "CannyA8_S4.cc"
		__PRF_globalCounter[57u]++ ;

#line 422 "CannyA8_S2.sc"
		if (((r + rr) >= 0) && ((r + rr) < rows)) {

#line 1097 "CannyA8_S4.cc"
		    __PRF_globalCounter[58u]++ ;

#line 423 "CannyA8_S2.sc"
		    dot += tempim[(r + rr) * cols + c] * kernel[center + rr];
		    sum += kernel[center + rr];
		}
	    }

#line 1106 "CannyA8_S4.cc"
	    __PRF_globalCounter[59u]++ ;

#line 427 "CannyA8_S2.sc"
	    smoothedim[r * cols + c] = (short int)(dot * 9.000000000000000e+01 / sum + 5.000000000000000e-01);
	}
    }
}

#line 1115 "CannyA8_S4.cc"
void BlurY_Slice::main(void)

#line 433 "CannyA8_S2.sc"
{   

#line 1121 "CannyA8_S4.cc"
    __PRF_globalCounter[60u]++ ;

#line 434 "CannyA8_S2.sc"
    _specc::waitfor(((43740 * 1000000000ull) / 20) / 8);
    blur_y(1520, 2704);
}

#line 1129 "CannyA8_S4.cc"
...
#line 479 "CannyA8_S2.sc"
{   

#line 1197 "CannyA8_S4.cc"
    __PRF_globalCounter[97u]++ ;

#line 480 "CannyA8_S2.sc"
    receive.main();
    gauss.main();
}

#line 1205 "CannyA8_S4.cc"
...
#line 501 "CannyA8_S2.sc"
    int rows, int cols)
{   
    int c; int pos; int r;

#line 1222 "CannyA8_S4.cc"
    __PRF_globalCounter[67u]++ ;

#line 509 "CannyA8_S2.sc"
    if (0)

#line 1228 "CannyA8_S4.cc"
    {   
...
#line 1236 "CannyA8_S4.cc"
    __PRF_globalCounter[69u]++ ;

#line 510 "CannyA8_S2.sc"
    for(r = 0; r < rows; r++ ) {

#line 1242 "CannyA8_S4.cc"
	__PRF_globalCounter[70u]++ ;

#line 511 "CannyA8_S2.sc"
	pos = r * cols;
	delta_x[pos] = smoothedim[pos + 1] - smoothedim[pos];
	pos++ ;

#line 1250 "CannyA8_S4.cc"
	__PRF_globalCounter[71u]++ ;

#line 514 "CannyA8_S2.sc"
	for(c = 1; c < (cols - 1); c++  , pos++ ) {

#line 1256 "CannyA8_S4.cc"
	    __PRF_globalCounter[72u]++ ;

#line 515 "CannyA8_S2.sc"
	    delta_x[pos] = smoothedim[pos + 1] - smoothedim[pos - 1];
	}

#line 1263 "CannyA8_S4.cc"
	__PRF_globalCounter[73u]++ ;

#line 517 "CannyA8_S2.sc"
	delta_x[pos] = smoothedim[pos] - smoothedim[pos - 1];
    }

#line 1270 "CannyA8_S4.cc"
    __PRF_globalCounter[74u]++ ;

#line 524 "CannyA8_S2.sc"
    if (0)

#line 1276 "CannyA8_S4.cc"
    {   
...
#line 1284 "CannyA8_S4.cc"
    __PRF_globalCounter[76u]++ ;

#line 525 "CannyA8_S2.sc"
    for(c = 0; c < cols; c++ ) {

#line 1290 "CannyA8_S4.cc"
	__PRF_globalCounter[77u]++ ;

#line 526 "CannyA8_S2.sc"
	pos = c;
	delta_y[pos] = smoothedim[pos + cols] - smoothedim[pos];
	pos += cols;

#line 1298 "CannyA8_S4.cc"
	__PRF_globalCounter[78u]++ ;

#line 529 "CannyA8_S2.sc"
	for(r = 1; r < (rows - 1); r++  , pos += cols) {

#line 1304 "CannyA8_S4.cc"
	    __PRF_globalCounter[79u]++ ;

#line 530 "CannyA8_S2.sc"
	    delta_y[pos] = smoothedim[pos + cols] - smoothedim[pos - cols];
	}

#line 1311 "CannyA8_S4.cc"
	__PRF_globalCounter[80u]++ ;

#line 532 "CannyA8_S2.sc"
	delta_y[pos] = smoothedim[pos] - smoothedim[pos - cols];
    }
}

#line 1319 "CannyA8_S4.cc"
void Derivative_X_Y::main(void)

#line 537 "CannyA8_S2.sc"
{   

#line 1325 "CannyA8_S4.cc"
    __PRF_globalCounter[81u]++ ;

#line 538 "CannyA8_S2.sc"
    _specc::waitfor((5340 * 1000000000ull) / 20);
    derivative_x_y(1520, 2704);
}

#line 1333 "CannyA8_S4.cc"
...
#line 553 "CannyA8_S2.sc"
    int rows, int cols)
{   
    int c; int pos; int r; int sq1; int sq2;

#line 1350 "CannyA8_S4.cc"
    __PRF_globalCounter[98u]++ ;

#line 557 "CannyA8_S2.sc"
    for(r = 0 , pos = 0; r < rows; r++ ) {

#line 1356 "CannyA8_S4.cc"
	__PRF_globalCounter[99u]++ ;

#line 558 "CannyA8_S2.sc"
	for(c = 0; c < cols; c++  , pos++ ) {

#line 1362 "CannyA8_S4.cc"
	    __PRF_globalCounter[100u]++ ;

#line 559 "CannyA8_S2.sc"
...
#line 1373 "CannyA8_S4.cc"
void Magnitude_X_Y::main(void)

#line 567 "CannyA8_S2.sc"
{   

#line 1379 "CannyA8_S4.cc"
    __PRF_globalCounter[101u]++ ;

#line 568 "CannyA8_S2.sc"
    _specc::waitfor((5340 * 1000000000ull) / 20);
...
#line 787 "CannyA8_S2.sc"
{   
    unsigned char result[4110080];

#line 1405 "CannyA8_S4.cc"
    __PRF_globalCounter[129u]++ ;

#line 790 "CannyA8_S2.sc"
...
#line 1415 "CannyA8_S4.cc"
void Non_Max_Supp::non_max_supp(

#line 585 "CannyA8_S2.sc"
...
#line 1429 "CannyA8_S4.cc"
    __PRF_globalCounter[130u]++ ;

#line 598 "CannyA8_S2.sc"
    for(count = 0 , resultrowptr = result , resultptr = result + ncols * (nrows - 1); 
	count < ncols; resultptr++  , resultrowptr++  , count++ ) {

#line 1436 "CannyA8_S4.cc"
	__PRF_globalCounter[131u]++ ;

#line 600 "CannyA8_S2.sc"
	 *resultrowptr =  *resultptr = (unsigned char)0;
    }

#line 1443 "CannyA8_S4.cc"
    __PRF_globalCounter[132u]++ ;

#line 603 "CannyA8_S2.sc"
    for(count = 0 , resultptr = result , resultrowptr = result + ncols - 1; 
	count < nrows; count++  , resultptr += ncols , resultrowptr += ncols) {

#line 1450 "CannyA8_S4.cc"
	__PRF_globalCounter[133u]++ ;

#line 605 "CannyA8_S2.sc"
	 *resultptr =  *resultrowptr = (unsigned char)0;
    }

#line 1457 "CannyA8_S4.cc"
    __PRF_globalCounter[134u]++ ;

#line 611 "CannyA8_S2.sc"
...
#line 1467 "CannyA8_S4.cc"
	__PRF_globalCounter[135u]++ ;

#line 616 "CannyA8_S2.sc"
	for(colcount = 1 , magptr = magrowptr , gxptr = gxrowptr , gyptr = gyrowptr , 
	    resultptr = resultrowptr; colcount <= ncols - 2; 
	    colcount++  , magptr++  , gxptr++  , gyptr++  , resultptr++ ) {

#line 1475 "CannyA8_S4.cc"
	    __PRF_globalCounter[136u]++ ;

#line 619 "CannyA8_S2.sc"
	    m00 =  *magptr;

#line 1481 "CannyA8_S4.cc"
	    __PRF_globalCounter[137u]++ ;

#line 620 "CannyA8_S2.sc"
	    if (m00 == 0) {

#line 1487 "CannyA8_S4.cc"
		__PRF_globalCounter[138u]++ ;

#line 621 "CannyA8_S2.sc"
		 *resultptr = (unsigned char)255;
	    }
	    else  {

#line 1495 "CannyA8_S4.cc"
		__PRF_globalCounter[139u]++ ;

#line 626 "CannyA8_S2.sc"
		gx =  *gxptr;
		gy =  *gyptr;
		xperp =  -(gx << 16) / m00;
		yperp = (gy << 16) / m00;
...
#line 1505 "CannyA8_S4.cc"
	    __PRF_globalCounter[140u]++ ;

#line 632 "CannyA8_S2.sc"
	    if (gx >= 0) {

#line 1511 "CannyA8_S4.cc"
		__PRF_globalCounter[141u]++ ;

#line 633 "CannyA8_S2.sc"
		if (gy >= 0) {

#line 1517 "CannyA8_S4.cc"
		    __PRF_globalCounter[142u]++ ;

#line 634 "CannyA8_S2.sc"
		    if (gx >= gy)
		    {   

#line 1524 "CannyA8_S4.cc"
			__PRF_globalCounter[143u]++ ;

#line 638 "CannyA8_S2.sc"
			z1 =  *(magptr - 1);
			z2 =  *(magptr - ncols - 1);
...
#line 1542 "CannyA8_S4.cc"
			__PRF_globalCounter[144u]++ ;

#line 653 "CannyA8_S2.sc"
			z1 =  *(magptr - ncols);
			z2 =  *(magptr - ncols - 1);
...
#line 1561 "CannyA8_S4.cc"
		    __PRF_globalCounter[145u]++ ;

#line 667 "CannyA8_S2.sc"
		    if (gx >=  -gy)
		    {   

#line 1568 "CannyA8_S4.cc"
			__PRF_globalCounter[146u]++ ;

#line 671 "CannyA8_S2.sc"
			z1 =  *(magptr - 1);
			z2 =  *(magptr + ncols - 1);
...
#line 1586 "CannyA8_S4.cc"
			__PRF_globalCounter[147u]++ ;

#line 686 "CannyA8_S2.sc"
			z1 =  *(magptr + ncols);
			z2 =  *(magptr + ncols - 1);
...
#line 1606 "CannyA8_S4.cc"
		__PRF_globalCounter[148u]++ ;

#line 701 "CannyA8_S2.sc"
		if ((gy =  *gyptr) >= 0)
		{   

#line 1613 "CannyA8_S4.cc"
		    __PRF_globalCounter[149u]++ ;

#line 703 "CannyA8_S2.sc"
		    if ( -gx >= gy)
		    {   

#line 1620 "CannyA8_S4.cc"
			__PRF_globalCounter[150u]++ ;

#line 707 "CannyA8_S2.sc"
			z1 =  *(magptr + 1);
			z2 =  *(magptr - ncols + 1);
...
#line 1638 "CannyA8_S4.cc"
			__PRF_globalCounter[151u]++ ;

#line 722 "CannyA8_S2.sc"
			z1 =  *(magptr - ncols);
			z2 =  *(magptr - ncols + 1);
...
#line 1657 "CannyA8_S4.cc"
		    __PRF_globalCounter[152u]++ ;

#line 736 "CannyA8_S2.sc"
		    if ( -gx >  -gy)
		    {   

#line 1664 "CannyA8_S4.cc"
			__PRF_globalCounter[153u]++ ;

#line 740 "CannyA8_S2.sc"
			z1 =  *(magptr + 1);
			z2 =  *(magptr + ncols + 1);
...
#line 1682 "CannyA8_S4.cc"
			__PRF_globalCounter[154u]++ ;

#line 755 "CannyA8_S2.sc"
			z1 =  *(magptr + ncols);
			z2 =  *(magptr + ncols + 1);
...
#line 1700 "CannyA8_S4.cc"
	    __PRF_globalCounter[155u]++ ;

#line 771 "CannyA8_S2.sc"
	    if ((mag1 > 0.000000000000000e+00) || (mag2 > 0.000000000000000e+00))
	    {   

#line 1707 "CannyA8_S4.cc"
		__PRF_globalCounter[156u]++ ;

#line 773 "CannyA8_S2.sc"
		 *resultptr = (unsigned char)255;
	    }
	    else 
	    {   

#line 1716 "CannyA8_S4.cc"
		__PRF_globalCounter[157u]++ ;

#line 777 "CannyA8_S2.sc"
		if (mag2 == 0.000000000000000e+00)

#line 1722 "CannyA8_S4.cc"
		{   
		    __PRF_globalCounter[158u]++ ;

#line 778 "CannyA8_S2.sc"
		     *resultptr = (unsigned char)255;
		}
		else 

#line 1731 "CannyA8_S4.cc"
		{   
		    __PRF_globalCounter[159u]++ ;

#line 780 "CannyA8_S2.sc"
...
#line 1762 "CannyA8_S4.cc"
    __PRF_globalCounter[0u]++ ;

#line 850 "CannyA8_S2.sc"
    for(r = 0 , pos = 0; r < rows; r++ ) {

#line 1768 "CannyA8_S4.cc"
	__PRF_globalCounter[1u]++ ;

#line 851 "CannyA8_S2.sc"
	for(c = 0; c < cols; c++  , pos++ ) {

#line 1774 "CannyA8_S4.cc"
	    __PRF_globalCounter[2u]++ ;

#line 852 "CannyA8_S2.sc"
	    if (nms[pos] == 128)

#line 1780 "CannyA8_S4.cc"
	    {   
...
#line 1789 "CannyA8_S4.cc"
	    {   
		__PRF_globalCounter[4u]++ ;

#line 853 "CannyA8_S2.sc"
		edge[pos] = 255;
	    }
	}
    }

#line 1799 "CannyA8_S4.cc"
    __PRF_globalCounter[5u]++ ;

#line 857 "CannyA8_S2.sc"
    for(r = 0 , pos = 0; r < rows; r++  , pos += cols) {

#line 1805 "CannyA8_S4.cc"
	__PRF_globalCounter[6u]++ ;

#line 858 "CannyA8_S2.sc"
	edge[pos] = 255;
	edge[pos + cols - 1] = 255;
    }

#line 1813 "CannyA8_S4.cc"
    __PRF_globalCounter[7u]++ ;

#line 861 "CannyA8_S2.sc"
    pos = (rows - 1) * cols;

#line 1819 "CannyA8_S4.cc"
    __PRF_globalCounter[8u]++ ;

#line 862 "CannyA8_S2.sc"
    for(c = 0; c < cols; c++  , pos++ ) {

#line 1825 "CannyA8_S4.cc"
	__PRF_globalCounter[9u]++ ;

#line 863 "CannyA8_S2.sc"
	edge[c] = 255;
	edge[pos] = 255;
    }

#line 1833 "CannyA8_S4.cc"
    __PRF_globalCounter[10u]++ ;

#line 871 "CannyA8_S2.sc"
    for(r = 0; r < 32768; r++ )

#line 1839 "CannyA8_S4.cc"
    {   
...
#line 1847 "CannyA8_S4.cc"
    __PRF_globalCounter[12u]++ ;

#line 872 "CannyA8_S2.sc"
    for(r = 0 , pos = 0; r < rows; r++ ) {

#line 1853 "CannyA8_S4.cc"
	__PRF_globalCounter[13u]++ ;

#line 873 "CannyA8_S2.sc"
	for(c = 0; c < cols; c++  , pos++ ) {

#line 1859 "CannyA8_S4.cc"
	    __PRF_globalCounter[14u]++ ;

#line 874 "CannyA8_S2.sc"
	    if (edge[pos] == 128)

#line 1865 "CannyA8_S4.cc"
	    {   
...
#line 1875 "CannyA8_S4.cc"
    __PRF_globalCounter[16u]++ ;

#line 881 "CannyA8_S2.sc"
    for(r = 1 , numedges = 0; r < 32768; r++ ) {

#line 1881 "CannyA8_S4.cc"
	__PRF_globalCounter[17u]++ ;

#line 882 "CannyA8_S2.sc"
	if (hist[r] != 0)

#line 1887 "CannyA8_S4.cc"
	{   
...
#line 1895 "CannyA8_S4.cc"
	__PRF_globalCounter[19u]++ ;

#line 883 "CannyA8_S2.sc"
	numedges += hist[r];
    }

#line 1902 "CannyA8_S4.cc"
    __PRF_globalCounter[20u]++ ;

#line 886 "CannyA8_S2.sc"
    highcount = (int)(numedges * thigh + 5.000000000000000e-01);

#line 898 "CannyA8_S2.sc"
    r = 1;
    numedges = hist[1];

#line 1912 "CannyA8_S4.cc"
    __PRF_globalCounter[21u]++ ;

#line 900 "CannyA8_S2.sc"
    while((r < (maximum_mag - 1)) && (numedges < highcount)) {

#line 1918 "CannyA8_S4.cc"
	__PRF_globalCounter[22u]++ ;

#line 901 "CannyA8_S2.sc"
	r++ ;
	numedges += hist[r];
    }

#line 1926 "CannyA8_S4.cc"
    __PRF_globalCounter[23u]++ ;

#line 904 "CannyA8_S2.sc"
    highthreshold = r;
    lowthreshold = (int)(highthreshold * tlow + 5.000000000000000e-01);

#line 1933 "CannyA8_S4.cc"
    __PRF_globalCounter[24u]++ ;

#line 907 "CannyA8_S2.sc"
    if (0) {

#line 1939 "CannyA8_S4.cc"
	__PRF_globalCounter[25u]++ ;

#line 908 "CannyA8_S2.sc"
...
#line 1949 "CannyA8_S4.cc"
    __PRF_globalCounter[26u]++ ;

#line 918 "CannyA8_S2.sc"
    for(r = 0 , pos = 0; r < rows; r++ ) {

#line 1955 "CannyA8_S4.cc"
	__PRF_globalCounter[27u]++ ;

#line 919 "CannyA8_S2.sc"
	for(c = 0; c < cols; c++  , pos++ ) {

#line 1961 "CannyA8_S4.cc"
	    __PRF_globalCounter[28u]++ ;

#line 920 "CannyA8_S2.sc"
	    if ((edge[pos] == 128) && (mag[pos] >= highthreshold)) {

#line 1967 "CannyA8_S4.cc"
		__PRF_globalCounter[29u]++ ;

#line 921 "CannyA8_S2.sc"
		edge[pos] = 0;
...
#line 1977 "CannyA8_S4.cc"
    __PRF_globalCounter[30u]++ ;

#line 930 "CannyA8_S2.sc"
    for(r = 0 , pos = 0; r < rows; r++ ) {

#line 1983 "CannyA8_S4.cc"
	__PRF_globalCounter[31u]++ ;

#line 931 "CannyA8_S2.sc"
	for(c = 0; c < cols; c++  , pos++ )

#line 1989 "CannyA8_S4.cc"
	{   
...
#line 2007 "CannyA8_S4.cc"
void Apply_Hysteresis::follow_edges(

#line 809 "CannyA8_S2.sc"
...
#line 2020 "CannyA8_S4.cc"
    __PRF_globalCounter[34u]++ ;

#line 818 "CannyA8_S2.sc"
    for(i = 0; i < 8; i++ ) {

#line 2026 "CannyA8_S4.cc"
	__PRF_globalCounter[35u]++ ;

#line 819 "CannyA8_S2.sc"
	tempmapptr = edgemapptr - y[i] * cols + x[i];
	tempmagptr = edgemagptr - y[i] * cols + x[i];

#line 2033 "CannyA8_S4.cc"
	__PRF_globalCounter[36u]++ ;

#line 822 "CannyA8_S2.sc"
	if (( *tempmapptr == 128) && ( *tempmagptr > lowval)) {

#line 2039 "CannyA8_S4.cc"
	    __PRF_globalCounter[37u]++ ;

#line 823 "CannyA8_S2.sc"
...
#line 2049 "CannyA8_S4.cc"
void Apply_Hysteresis::main(void)

#line 936 "CannyA8_S2.sc"
{   

#line 2055 "CannyA8_S4.cc"
    __PRF_globalCounter[38u]++ ;

#line 937 "CannyA8_S2.sc"
...
#line 973 "CannyA8_S2.sc"
{   

#line 2086 "CannyA8_S4.cc"
    __PRF_globalCounter[61u]++ ;

#line 977 "CannyA8_S2.sc"
...
#line 1037 "CannyA8_S2.sc"
{   

#line 2173 "CannyA8_S4.cc"
    __PRF_startProfiler("CannyA8_S4.bb_counter.prf", "CannyA8_S4.fn_counter.prf", 
	__PRF_globalCounter, 197u);

#line 1038 "CannyA8_S2.sc"
...
#line 2184 "CannyA8_S4.cc"
    __PRF_globalCounter[103u]++ ;

#line 1043 "CannyA8_S2.sc"
    return 0;
}

#line 2191 "CannyA8_S4.cc"
