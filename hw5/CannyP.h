...
#line 67 "CannyP.sc"
    i_img_sender (&Outport);
public:

#line 710 "CannyP.h"
    Stimulus(unsigned int _idcnt, i_img_sender (&Outport));
    virtual ~Stimulus(void);
    void main(void);
private:

#line 68 "CannyP.sc"
    unsigned char imagein[4110080];
    char infilename[70];
};
...
#line 89 "CannyP.sc"
    i_img_receiver (&Inport); i_img_sender (&Outport);
public:

#line 730 "CannyP.h"
    DataIn(unsigned int _idcnt, i_img_receiver (&Inport), i_img_sender (&Outport));
    virtual ~DataIn(void);
    void main(void);
private:
...
#line 103 "CannyP.sc"
class Canny : public _specc::behavior
{
private:
...
#line 749 "CannyP.h"
    Canny(unsigned int _idcnt, i_img_receiver (&Inport), i_img_sender (&Outport));
    virtual ~Canny(void);
    void main(void);
private:
...
#line 771 "CannyP.h"
    DataOut(unsigned int _idcnt, i_img_receiver (&Inport), i_img_sender (&Outport));
...
#line 135 "CannyP.sc"
    i_img_receiver (&Inport);
public:

#line 790 "CannyP.h"
    Monitor(unsigned int _idcnt, i_img_receiver (&Inport));
...
#line 812 "CannyP.h"
    Platform(unsigned int _idcnt, i_img_receiver (&Inport), i_img_sender (&Outport));
...
#line 160 "CannyP.sc"
    c_img_queue ImageInC;
    c_img_queue ImageOutC;
};
...
extern "C" void __assert_perror_fail(int, const char *, unsigned int, const char *);
...
#line 1864 "CannyP.h"
void canny(unsigned char *, int, int, float, float, float, unsigned char *);
