...
{ "-lscprof" }; */
/* note _SCE_LOG = 
{ { "Sun May 21 10:14:29 2017","scc Canny -sc2sir -I -P -L -l -xcx -xlx -I/opt/sce/inc -P. -P/opt/sce/import -L/opt/sce/lib -lbit4 -lbit -lsim -llonglong -lqthread -xl -Xlinker -xl -R -xl -Xlinker -xl /opt/sce/lib -i Canny.sc -o Canny.sir",
    "Canny.sc","V2.2.1","" },
  { "Sun May 21 10:15:26 2017","sce","Canny.sc","V2.2.1","Saved to /users/ugrad/2016/fall/jienengy/eecs222/hw6/CannyA6.sir" },
  
  { "Sun May 21 10:19:02 2017","scprof -v -m -i /users/ugrad/2016/fall/jienengy/eecs222/hw6/CannyA6 -o /users/ugrad/2016/fall/jienengy/eecs222/hw6/CannyA6.ins.sir CannyA6 ",
    "CannyA6","V2.2.1","Profile Instrumentation Simple mode" } }; */
