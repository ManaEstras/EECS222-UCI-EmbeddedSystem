...
{ "-lscprof" }; */
/* note _SCE_LOG = 
{ { "Sun May 21 21:14:11 2017","scc Canny -sc2sir -I -P -L -l -xcx -xlx -I/opt/sce/inc -P. -P/opt/sce/import -L/opt/sce/lib -lbit4 -lbit -lsim -llonglong -lqthread -xl -Xlinker -xl -R -xl -Xlinker -xl /opt/sce/lib -i Canny.sc -o Canny.sir",
    "Canny.sc","V2.2.1","" },
  { "Sun May 21 21:14:32 2017","sce","Canny.sc","V2.2.1","Saved to /users/ugrad/2016/fall/jienengy/eecs222/hw6/Canny66.sir" },
  
  { "Sun May 21 21:14:32 2017","scprof -v -m -i /users/ugrad/2016/fall/jienengy/eecs222/hw6/Canny66 -o /users/ugrad/2016/fall/jienengy/eecs222/hw6/Canny66.ins.sir Canny66 ",
    "Canny66","V2.2.1","Profile Instrumentation Simple mode" } }; */
...
typedef float float1[4110080];
typedef float float2[21];
...
#line 56 "Canny.sc"
/* note i_simg_sender._SCE_STANDARD_LIB = { "i_sender","simg","simg" }; */

#line 645 "Canny66.h"
class i_simg_receiver;

#line 57 "Canny.sc"
/* note i_simg_receiver._SCE_STANDARD_LIB = { "i_receiver","simg","simg" }; */

#line 651 "Canny66.h"
class i_simg_tranceiver;

#line 58 "Canny.sc"
/* note i_simg_tranceiver._SCE_STANDARD_LIB = { "i_tranceiver","simg","simg" }; */

#line 657 "Canny66.h"
class c_simg_queue;

#line 60 "Canny.sc"
/* note c_simg_queue._SCE_STANDARD_LIB = { "c_queue","simg","simg" }; */

#line 663 "Canny66.h"
class i_float1_sender;

#line 63 "Canny.sc"
/* note i_float1_sender._SCE_STANDARD_LIB = { "i_sender","float1","float1" }; */

#line 669 "Canny66.h"
class i_float1_receiver;

#line 64 "Canny.sc"
/* note i_float1_receiver._SCE_STANDARD_LIB = { "i_receiver","float1","float1" }; */

#line 675 "Canny66.h"
class i_float1_tranceiver;

#line 65 "Canny.sc"
/* note i_float1_tranceiver._SCE_STANDARD_LIB = { "i_tranceiver","float1","float1" }; */

#line 681 "Canny66.h"
class c_float1_queue;

#line 67 "Canny.sc"
/* note c_float1_queue._SCE_STANDARD_LIB = { "c_queue","float1","float1" }; */

#line 687 "Canny66.h"
class i_float2_sender;

#line 69 "Canny.sc"
/* note i_float2_sender._SCE_STANDARD_LIB = { "i_sender","float2","float2" }; */

#line 693 "Canny66.h"
class i_float2_receiver;

#line 70 "Canny.sc"
/* note i_float2_receiver._SCE_STANDARD_LIB = { "i_receiver","float2","float2" }; */

#line 699 "Canny66.h"
class i_float2_tranceiver;

#line 71 "Canny.sc"
/* note i_float2_tranceiver._SCE_STANDARD_LIB = { "i_tranceiver","float2","float2" }; */

#line 705 "Canny66.h"
class c_float2_queue;

#line 73 "Canny.sc"
/* note c_float2_queue._SCE_STANDARD_LIB = { "c_queue","float2","float2" }; */
...
#line 779 "Canny66.h"
    virtual ~i_simg_sender(void){};

#line 56 "Canny.sc"
    virtual void send(short int [4110080]) = 0;
private:
};
...
#line 793 "Canny66.h"
    virtual ~i_simg_receiver(void){};

#line 57 "Canny.sc"
    virtual void receive(short int (*)[4110080]) = 0;
private:
};
...
#line 807 "Canny66.h"
    virtual ~i_simg_tranceiver(void){};

#line 58 "Canny.sc"
    virtual void receive(short int (*)[4110080]) = 0; virtual void send(short int [4110080]) = 0;
private:
};
...
#line 821 "Canny66.h"
    virtual ~i_float1_sender(void){};

#line 63 "Canny.sc"
    virtual void send(float [4110080]) = 0;
private:
};
...
#line 835 "Canny66.h"
    virtual ~i_float1_receiver(void){};

#line 64 "Canny.sc"
    virtual void receive(float (*)[4110080]) = 0;
private:
};
...
#line 849 "Canny66.h"
    virtual ~i_float1_tranceiver(void){};

#line 65 "Canny.sc"
    virtual void receive(float (*)[4110080]) = 0; virtual void send(float [4110080]) = 0;
private:
};
...
#line 862 "Canny66.h"
    virtual ~i_float2_sender(void){};

#line 69 "Canny.sc"
    virtual void send(float [21]) = 0;
private:
};
...
#line 876 "Canny66.h"
    virtual ~i_float2_receiver(void){};

#line 70 "Canny.sc"
    virtual void receive(float (*)[21]) = 0;
private:
};
...
#line 890 "Canny66.h"
    virtual ~i_float2_tranceiver(void){};

#line 71 "Canny.sc"
    virtual void receive(float (*)[21]) = 0; virtual void send(float [21]) = 0;
private:
};
...
#line 60 "Canny.sc"
class c_simg_queue : public _specc::channel, public i_simg_sender, public i_simg_receiver, public i_simg_tranceiver
{
private:
...
#line 931 "Canny66.h"
    c_simg_queue(const unsigned long int (&size));
    virtual ~c_simg_queue(void);
    void cleanup(void);
    void receive(short int (*)[4110080]);
    void send(short int [4110080]);
    void setup(void);
private:

#line 60 "Canny.sc"
    short int (*buffer)[4110080]; unsigned long int n; unsigned long int p; _specc::event r; _specc::event s; unsigned long int wr; unsigned long int ws;
};

#line 67 "Canny.sc"
class c_float1_queue : public _specc::channel, public i_float1_sender, public i_float1_receiver, public i_float1_tranceiver
{
private:
...
#line 953 "Canny66.h"
    c_float1_queue(const unsigned long int (&size));
    virtual ~c_float1_queue(void);
    void cleanup(void);
    void receive(float (*)[4110080]);
    void send(float [4110080]);
    void setup(void);
private:

#line 67 "Canny.sc"
    float (*buffer)[4110080]; unsigned long int n; unsigned long int p; _specc::event r; _specc::event s; unsigned long int wr; unsigned long int ws;
};




class c_float2_queue : public _specc::channel, public i_float2_sender, public i_float2_receiver, public i_float2_tranceiver
{
private:
...
#line 977 "Canny66.h"
    c_float2_queue(const unsigned long int (&size));
    virtual ~c_float2_queue(void);
    void cleanup(void);
    void receive(float (*)[21]);
    void send(float [21]);
    void setup(void);
private:

#line 73 "Canny.sc"
    float (*buffer)[21]; unsigned long int n; unsigned long int p; _specc::event r; _specc::event s; unsigned long int wr; unsigned long int ws;
};
...
#line 268 "Canny.sc"
class receiveImage : public _specc::behavior
{
private:

#line 268 "Canny.sc"
    i_img_receiver (&ImgIn); unsigned char (&ImgOut)[4110080];
public:

#line 1075 "Canny66.h"
    receiveImage(unsigned int _idcnt, i_img_receiver (&ImgIn), unsigned char (&ImgOut)[4110080]);
    virtual ~receiveImage(void);
    void main();
private:
...
#line 281 "Canny.sc"
class make_gaussian_kernel : public _specc::behavior
{
private:
...
#line 1094 "Canny66.h"
    make_gaussian_kernel(unsigned int _idcnt, float (&kernelout)[21]);
    virtual ~make_gaussian_kernel(void);
    void main();
    void make_gaussian_kernel1(float, float *, int *);
private:
...
#line 326 "Canny.sc"
    float (&kernelin)[21]; unsigned char (&ImgIn)[4110080]; float (&tempimout)[4110080];
public:

#line 1122 "Canny66.h"
    blurX(unsigned int _idcnt, float (&kernelin)[21], unsigned char (&ImgIn)[4110080], float (&tempimout)[4110080]);
    virtual ~blurX(void);
    void main();
private:
...
#line 366 "Canny.sc"
    float (&kernelin)[21]; float (&tempimin)[4110080]; short int (&smoothedimout)[4110080];
public:

#line 1172 "Canny66.h"
    blurY(unsigned int _idcnt, float (&kernelin)[21], float (&tempimin)[4110080], short int (&smoothedimout)[4110080]);
    virtual ~blurY(void);
    void main();
private:
...
#line 407 "Canny.sc"
    i_img_receiver (&ImgIn); short int (&sImgOut)[4110080];
public:

#line 1219 "Canny66.h"
    gaussian_smooth(unsigned int _idcnt, i_img_receiver (&ImgIn), short int (&sImgOut)[4110080]);
...
#line 432 "Canny.sc"
    short int (&sImgIn)[4110080]; short int (&xImgOut)[4110080]; short int (&yImgOut)[4110080];
public:

#line 1253 "Canny66.h"
    derivative_x_y(unsigned int _idcnt, short int (&sImgIn)[4110080], short int (&xImgOut)[4110080], short int (&yImgOut)[4110080]);
    virtual ~derivative_x_y(void);
    void derivative_x_y1(short int *, int, int, short int *, short int *);
    void main();
private:
...
#line 489 "Canny.sc"
    short int (&DxIn)[4110080]; short int (&DyIn)[4110080]; short int (&magOut)[4110080];
public:

#line 1281 "Canny66.h"
    magnitude_x_y(unsigned int _idcnt, short int (&DxIn)[4110080], short int (&DyIn)[4110080], short int (&magOut)[4110080]);
...
#line 517 "Canny.sc"
    short int (&magIn)[4110080]; short int (&DxIn)[4110080]; short int (&DyIn)[4110080]; unsigned char (&nmsOut)[4110080];
public:

#line 1316 "Canny66.h"
    non_max_supp(unsigned int _idcnt, short int (&magIn)[4110080], short int (&DxIn)[4110080], short int (&DyIn)[4110080], unsigned char (&nmsOut)[4110080]);
    virtual ~non_max_supp(void);
    void main();
    void non_max_supp1(short int *, short int *, short int *, int, int, unsigned char *);
private:
...
#line 522 "Canny.sc"
    short int *gyptr; short int *gyrowptr;
    short int m00;
    float mag1; float mag2;
...
#line 524 "Canny.sc"
    float xperp; float yperp;

#line 522 "Canny.sc"
    short int z1; short int z2;
};
...
#line 745 "Canny.sc"
    short int (&magIn)[4110080]; unsigned char (&nmsIn)[4110080]; i_img_sender (&ImgOut);
public:

#line 1385 "Canny66.h"
    apply_hysteresis(unsigned int _idcnt, short int (&magIn)[4110080], unsigned char (&nmsIn)[4110080], i_img_sender (&ImgOut));
    virtual ~apply_hysteresis(void);
    void apply_hysteresis1(short int *, unsigned char *, int, int, float, float, unsigned char *);
...
#line 905 "Canny.sc"
    short int dx[4110080]; short int dy[4110080]; short int mag[4110080];

#line 904 "Canny.sc"
    unsigned char nmsq[4110080];
    short int sml[4110080];

#line 911 "Canny.sc"
    apply_hysteresis ahy;
