...
#line 1016 "Canny66.cc"
    __PRF_globalCounter[124u]++ ;

#line 347 "Canny.sc"
    if (0)

#line 1022 "Canny66.cc"
    {   
...
#line 1030 "Canny66.cc"
    __PRF_globalCounter[126u]++ ;

#line 348 "Canny.sc"
    for(r = 0; r < rows; r++ ) {

#line 1036 "Canny66.cc"
	__PRF_globalCounter[127u]++ ;

#line 349 "Canny.sc"
	for(c = 0; c < cols; c++ ) {

#line 1042 "Canny66.cc"
...
#line 1049 "Canny66.cc"
	    __PRF_globalCounter[129u]++ ;

#line 352 "Canny.sc"
	    for(cc = ( -center); cc <= center; cc++ ) {

#line 1055 "Canny66.cc"
		__PRF_globalCounter[130u]++ ;

#line 353 "Canny.sc"
		if (((c + cc) >= 0) && ((c + cc) < cols)) {

#line 1061 "Canny66.cc"
...
#line 1111 "Canny66.cc"
    __PRF_globalCounter[135u]++ ;

#line 385 "Canny.sc"
    if (0)

#line 1117 "Canny66.cc"
    {   
...
#line 1125 "Canny66.cc"
    __PRF_globalCounter[137u]++ ;

#line 386 "Canny.sc"
    for(c = 0; c < cols; c++ ) {

#line 1131 "Canny66.cc"
	__PRF_globalCounter[138u]++ ;

#line 387 "Canny.sc"
	for(r = 0; r < rows; r++ ) {

#line 1137 "Canny66.cc"
...
#line 1144 "Canny66.cc"
	    __PRF_globalCounter[140u]++ ;

#line 390 "Canny.sc"
	    for(rr = ( -center); rr <= center; rr++ ) {

#line 1150 "Canny66.cc"
		__PRF_globalCounter[141u]++ ;

#line 391 "Canny.sc"
		if (((r + rr) >= 0) && ((r + rr) < rows)) {

#line 1156 "Canny66.cc"
...
#line 1229 "Canny66.cc"
    __PRF_globalCounter[145u]++ ;

#line 448 "Canny.sc"
    if (0)

#line 1235 "Canny66.cc"
    {   
...
#line 1243 "Canny66.cc"
    __PRF_globalCounter[147u]++ ;

#line 449 "Canny.sc"
    for(r = 0; r < rows; r++ ) {

#line 1249 "Canny66.cc"
...
#line 1257 "Canny66.cc"
	__PRF_globalCounter[149u]++ ;

#line 453 "Canny.sc"
	for(c = 1; c < (cols - 1); c++  , pos++ ) {

#line 1263 "Canny66.cc"
...
#line 1277 "Canny66.cc"
    __PRF_globalCounter[152u]++ ;

#line 463 "Canny.sc"
    if (0)

#line 1283 "Canny66.cc"
    {   
...
#line 1291 "Canny66.cc"
    __PRF_globalCounter[154u]++ ;

#line 464 "Canny.sc"
    for(c = 0; c < cols; c++ ) {

#line 1297 "Canny66.cc"
...
#line 1305 "Canny66.cc"
	__PRF_globalCounter[156u]++ ;

#line 468 "Canny.sc"
	for(r = 1; r < (rows - 1); r++  , pos += cols) {

#line 1311 "Canny66.cc"
...
#line 1326 "Canny66.cc"
void derivative_x_y::main()

#line 475 "Canny.sc"
{   

#line 1332 "Canny66.cc"
...
#line 1368 "Canny66.cc"
    __PRF_globalCounter[162u]++ ;

#line 503 "Canny.sc"
    for(r = 0 , pos = 0; r < rows; r++ ) {

#line 1374 "Canny66.cc"
	__PRF_globalCounter[163u]++ ;

#line 504 "Canny.sc"
	for(c = 0; c < cols; c++  , pos++ ) {

#line 1380 "Canny66.cc"
...
#line 1487 "Canny66.cc"
	    __PRF_globalCounter[187u]++ ;

#line 569 "Canny.sc"
	    m00 =  *magptr;

#line 1493 "Canny66.cc"
	    __PRF_globalCounter[188u]++ ;

#line 570 "Canny.sc"
	    if (m00 == 0) {

#line 1499 "Canny66.cc"
...
#line 1515 "Canny66.cc"
	    __PRF_globalCounter[191u]++ ;

#line 578 "Canny.sc"
	    if (gx >= 0) {

#line 1521 "Canny66.cc"
		__PRF_globalCounter[192u]++ ;

#line 579 "Canny.sc"
		if (gy >= 0) {

#line 1527 "Canny66.cc"
...
#line 1776 "Canny66.cc"
    __PRF_globalCounter[84u]++ ;

#line 803 "Canny.sc"
    for(r = 0 , pos = 0; r < rows; r++ ) {

#line 1782 "Canny66.cc"
	__PRF_globalCounter[85u]++ ;

#line 804 "Canny.sc"
	for(c = 0; c < cols; c++  , pos++ ) {

#line 1788 "Canny66.cc"
	    __PRF_globalCounter[86u]++ ;

#line 805 "Canny.sc"
	    if (nms[pos] == 128)

#line 1794 "Canny66.cc"
	    {   
...
#line 1813 "Canny66.cc"
    __PRF_globalCounter[89u]++ ;

#line 810 "Canny.sc"
    for(r = 0 , pos = 0; r < rows; r++  , pos += cols) {

#line 1819 "Canny66.cc"
...
#line 1827 "Canny66.cc"
    __PRF_globalCounter[91u]++ ;

#line 814 "Canny.sc"
    pos = (rows - 1) * cols;

#line 1833 "Canny66.cc"
    __PRF_globalCounter[92u]++ ;

#line 815 "Canny.sc"
    for(c = 0; c < cols; c++  , pos++ ) {

#line 1839 "Canny66.cc"
...
#line 1847 "Canny66.cc"
    __PRF_globalCounter[94u]++ ;

#line 824 "Canny.sc"
    for(r = 0; r < 32768; r++ )

#line 1853 "Canny66.cc"
    {   
...
#line 1861 "Canny66.cc"
    __PRF_globalCounter[96u]++ ;

#line 825 "Canny.sc"
    for(r = 0 , pos = 0; r < rows; r++ ) {

#line 1867 "Canny66.cc"
	__PRF_globalCounter[97u]++ ;

#line 826 "Canny.sc"
	for(c = 0; c < cols; c++  , pos++ ) {

#line 1873 "Canny66.cc"
	    __PRF_globalCounter[98u]++ ;

#line 827 "Canny.sc"
	    if (edge[pos] == 128)

#line 1879 "Canny66.cc"
	    {   
...
#line 1889 "Canny66.cc"
    __PRF_globalCounter[100u]++ ;

#line 834 "Canny.sc"
    for(r = 1 , numedges = 0; r < 32768; r++ ) {

#line 1895 "Canny66.cc"
	__PRF_globalCounter[101u]++ ;

#line 835 "Canny.sc"
	if (hist[r] != 0)

#line 1901 "Canny66.cc"
	{   
...
#line 1926 "Canny66.cc"
    __PRF_globalCounter[105u]++ ;

#line 853 "Canny.sc"
    while((r < (maximum_mag - 1)) && (numedges < highcount)) {

#line 1932 "Canny66.cc"
...
#line 1947 "Canny66.cc"
    __PRF_globalCounter[108u]++ ;

#line 860 "Canny.sc"
    if (0) {

#line 1953 "Canny66.cc"
...
#line 1991 "Canny66.cc"
    __PRF_globalCounter[114u]++ ;

#line 883 "Canny.sc"
    for(r = 0 , pos = 0; r < rows; r++ ) {

#line 1997 "Canny66.cc"
	__PRF_globalCounter[115u]++ ;

#line 884 "Canny.sc"
	for(c = 0; c < cols; c++  , pos++ )

#line 2003 "Canny66.cc"
	{   
...
#line 2034 "Canny66.cc"
    __PRF_globalCounter[118u]++ ;

#line 771 "Canny.sc"
    for(i = 0; i < 8; i++ ) {

#line 2040 "Canny66.cc"
...
#line 2063 "Canny66.cc"
void apply_hysteresis::main()

#line 888 "Canny.sc"
{   

#line 2069 "Canny66.cc"
...
#line 2101 "Canny66.cc"
    __PRF_globalCounter[0u]++ ;

#line 915 "Canny.sc"
    while(1) {

#line 2107 "Canny66.cc"
	__PRF_globalCounter[1u]++ ;

#line 920 "Canny.sc"
	if (0)

#line 2113 "Canny66.cc"
	{   
...
#line 2121 "Canny66.cc"
	__PRF_globalCounter[3u]++ ;

#line 921 "Canny.sc"
	gs.main();

#line 2127 "Canny66.cc"
	__PRF_globalCounter[4u]++ ;

#line 926 "Canny.sc"
	if (0)

#line 2133 "Canny66.cc"
	{   
...
#line 2141 "Canny66.cc"
	__PRF_globalCounter[6u]++ ;

#line 927 "Canny.sc"
	dxy.main();

#line 2147 "Canny66.cc"
	__PRF_globalCounter[7u]++ ;

#line 932 "Canny.sc"
	if (0)

#line 2153 "Canny66.cc"
	{   
...
#line 2161 "Canny66.cc"
	__PRF_globalCounter[9u]++ ;

#line 933 "Canny.sc"
	magxy.main();

#line 2167 "Canny66.cc"
	__PRF_globalCounter[10u]++ ;

#line 938 "Canny.sc"
	if (0)

#line 2173 "Canny66.cc"
	{   
...
#line 2181 "Canny66.cc"
	__PRF_globalCounter[12u]++ ;

#line 939 "Canny.sc"
	nms.main();

#line 2187 "Canny66.cc"
	__PRF_globalCounter[13u]++ ;

#line 944 "Canny.sc"
	if (0)

#line 2193 "Canny66.cc"
	{   
...
#line 2259 "Canny66.cc"
    __PRF_startProfiler("Canny66.bb_counter.prf", "Canny66.fn_counter.prf", 
