...
typedef unsigned long long int del;
...
#line 332 "cannyu.sc"
    unsigned char (&image)[4110080]; float (&kernel)[21]; int (&center); int (&x); float (&tempim)[4110080];
public:

#line 918 "cannyu.h"
    BlurX_Slice(unsigned int _idcnt, unsigned char (&image)[4110080], float (&kernel)[21], int (&center), int (&x), float (&tempim)[4110080]);
...
#line 367 "cannyu.sc"
    ...
    float (&tempim)[4110080]; float (&k1)[21]; int (&center1);
public:

#line 936 "cannyu.h"
    BlurX(unsigned int _idcnt, unsigned char (&image)[4110080], float (&kernel)[21], int (&center), float (&tempim)[4110080], float (&k1)[21], int (&center1));
    virtual ~BlurX(void);
    void main(void);
private:
...
#line 399 "cannyu.sc"
    float (&tempim)[4110080]; float (&kernel)[21]; int (&center); int (&y); short int (&smoothedim)[4110080];
public:

#line 970 "cannyu.h"
    BlurY_Slice(unsigned int _idcnt, float (&tempim)[4110080], float (&kernel)[21], int (&center), int (&y), short int (&smoothedim)[4110080]);
...
#line 434 "cannyu.sc"
    float (&tempim)[4110080]; float (&k1)[21]; int (&center1); short int (&smoothedim)[4110080];
public:

#line 987 "cannyu.h"
    BlurY(unsigned int _idcnt, float (&tempim)[4110080], float (&k1)[21], int (&center1), short int (&smoothedim)[4110080]);
    virtual ~BlurY(void);
    void main(void);
private:
    int _scc_const_port_0;
...
#line 568 "cannyu.sc"
    short int (&gradx)[4110080]; short int (&grady)[4110080]; short int (&mag)[4110080]; unsigned char (&nms)[4110080]; short int (&mag5)[4110080];
public:

#line 1077 "cannyu.h"
    Non_Max_Supp(unsigned int _idcnt, short int (&gradx)[4110080], short int (&grady)[4110080], short int (&mag)[4110080], unsigned char (&nms)[4110080], short int (&mag5)[4110080]);
...
#line 939 "cannyu.sc"
    ...
    _specc::piped<int,2> center1;

#line 934 "cannyu.sc"
    _specc::piped<short int [4110080],1> delta_x;

#line 941 "cannyu.sc"
    _specc::piped<short int [4110080],2> delta_x1;

#line 935 "cannyu.sc"
    _specc::piped<short int [4110080],1> delta_y;

#line 942 "cannyu.sc"
    _specc::piped<short int [4110080],2> delta_y1;

#line 932 "cannyu.sc"
    _specc::piped<unsigned char [4110080],1> image;

#line 938 "cannyu.sc"
    _specc::piped<float [21],2> k1;
...
#line 943 "cannyu.sc"
    _specc::piped<short int [4110080],2> magnitude1;
