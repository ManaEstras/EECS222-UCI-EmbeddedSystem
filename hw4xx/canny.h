...
#line 1523 "canny.h"
int main(int, char *[]);
void canny(unsigned char [][320], int, int, float, float, float, unsigned char [][320], char []);
void radian_direction(short int *, short int *, int, int, float **, int, int);
double angle_radians(double, double);
void magnitude_x_y(short int [][320], short int [][320], int, int, short int [][320]);
void derrivative_x_y(short int [][320], int, int, short int [][320], short int [][320]);
void gaussian_smooth(unsigned char [][320], int, int, float, short int [][320]);
void make_gaussian_kernel(float, float **, int *);
int follow_edges(unsigned char *, short int *, short int, int);
void apply_hysteresis(short int [][320], unsigned char [][320], int, int, float, float, unsigned char [][320]);
void non_max_supp(short int [][320], short int [][320], short int [][320], int, int, unsigned char [][320]);
int read_pgm_image(char [], unsigned char [][320], int, int);
int write_pgm_image(const char [], unsigned char [][320], int, int, const char [], int);
